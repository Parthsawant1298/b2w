...
export default function B2WServicesWithStats() {
  ...
  const stats = [
    ...
    },
    {
      ...
      icon: (
        <svg className="w-6 h-6 sm:w-8 sm:h-8 text-cyan-600" fill="currentColor" viewBox="0 0 20 20">
  ...
  return (
    <div className="min-h-screen relative overflow-hidden" style={{backgroundColor: '#EFF9F0'}}>
      {/* Background Effects - Light theme */}
      <div className="absolute inset-0 z-0">
        <div className="absolute top-20 left-10 w-72 h-72 rounded-full blur-3xl" style={{backgroundColor: '#000000', opacity: 0.05}}></div>
        <div className="absolute bottom-20 right-10 w-96 h-96 rounded-full blur-3xl" style={{backgroundColor: '#000000', opacity: 0.03}}></div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] rounded-full blur-3xl" style={{backgroundColor: '#000000', opacity: 0.02}}></div>
      </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col items-center text-center gap-3 sm:gap-4 mb-8 sm:mb-10 md:mb-12">
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-black mb-2 tracking-tight leading-tight">
              Discover the Power of <span className="text-black">AI-Driven Development</span>
            </h2>
          ...
          <div className="grid gap-6 sm:gap-8 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
            {services.map((service, index) => (
              <div
                key={service.title}
                className="group relative overflow-hidden rounded-2xl sm:rounded-3xl bg-white shadow-lg border border-blue-500/30 transition-all duration-300 hover:shadow-2xl hover:-translate-y-1 hover:border-blue-400/50 shadow-lg shadow-blue-500/10"
              >
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8">
            {stats.map((stat, index) => (
              <div 
                key={index} 
                className={`group relative bg-white backdrop-blur-xl rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-lg border border-gray-300 hover:shadow-2xl hover:scale-105 hover:border-gray-400 transition-all duration-500 overflow-hidden shadow-lg shadow-gray-400/20`}
                style={{
              ...
              >
                ...
                {/* Icon */}
                <div className={`inline-flex items-center justify-center w-12 h-12 sm:w-16 sm:h-16 bg-white border border-gray-300 rounded-xl sm:rounded-2xl mb-3 sm:mb-4 group-hover:scale-110 transition-transform duration-300 backdrop-blur-xl`}>
                  {stat.icon}
                </div>
                ...
                {/* Hover effect border */}
                <div className="absolute inset-0 rounded-xl sm:rounded-2xl bg-gradient-to-r from-blue-500/10 to-cyan-500/10 opacity-0 group-hover:opacity-20 transition-opacity duration-300 -z-10"></div>
              </div>
            ))}
          </div>
          ...
          <div className="text-center mt-8 sm:mt-10 md:mt-12">
            <div className="inline-flex items-center space-x-2 text-gray-700 bg-black/10 backdrop-blur-xl border border-gray-400 px-4 sm:px-6 py-2 sm:py-3 rounded-full">
              <div className="flex -space-x-1 sm:-space-x-2">
                <div className="w-6 h-6 sm:w-8 sm:h-8 bg-blue-500 rounded-full border-2 border-white"></div>
                <div className="w-6 h-6 sm:w-8 sm:h-8 bg-cyan-500 rounded-full border-2 border-white"></div>
                <div className="w-6 h-6 sm:w-8 sm:h-8 bg-blue-400 rounded-full border-2 border-white"></div>
                <div className="w-6 h-6 sm:w-8 sm:h-8 bg-gradient-to-r from-blue-400 to-cyan-400 rounded-full border-2 border-white flex items-center justify-center text-white text-xs font-bold">
                  +
                </div>
              </div>
              <span className="text-xs sm:text-sm font-medium text-gray-700">Join thousands of successful businesses worldwide</span>
            </div>
          </div>
        </div>
      </div>
