...
export default function HeroServices() {
  ...
  return (
    <div className="bg-black min-h-[60vh] sm:min-h-[70vh] md:min-h-[80vh] py-8 sm:py-12 md:py-16 px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 relative overflow-hidden">
      ...
      <div className="flex items-center min-h-[50vh] sm:min-h-[60vh] md:min-h-[70vh] pt-8 sm:pt-10 md:pt-12 relative z-10">
        ...
        <div className="w-full text-center">
          ...
          <p className="text-base sm:text-lg md:text-xl text-gray-300 mb-8 sm:mb-10 max-w-4xl mx-auto animate-fade-in-up opacity-0 animation-delay-400">
            From web development to AI solutions, we provide comprehensive IT outsourcing services designed to 
            accelerate your digital transformation with cutting-edge technology and expert implementation.
          </p>
      ...
      {/* Services Stats - No Company Logos */}
